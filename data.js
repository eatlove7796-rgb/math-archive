...
= 10×(1 + 1/2) = 15`
  ...
  ,{
    id: "2017_11월_고1_18번",
    year: 2017, month: 11, grade: 1, num: 18,
    unit: "방정식과부등식",
    score: 4,
    type: "선택형",
    answer: "⑤",
    answerNum: 5,
    keywords: ["삼차방정식", "허근", "켤레복소수", "w³=1", "보기"],
    problemImg: `${GITHUB_IMG_BASE}/17_11_고1_18_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/17_11_고1_18_A.jpg`,
    problem: `삼차방정식 x³=1의 한 허근을 w라 할 때, <보기>에서 옳은 것만을 있는 대로 고른 것은?
(단, w̄는 w의 켤레복소수이다.) [4점]

ㄱ. w̄³=1
ㄴ. 1/w + (1/w)² = 1/w̄ + (1/w̄)²
ㄷ. (-w-1)ⁿ = (w̄/(w+w̄))ⁿ 을 만족시키는 100 이하의 자연수 n의 개수는 50이다.

① ㄱ   ② ㄷ   ③ ㄱ, ㄴ   ④ ㄴ, ㄷ   ⑤ ㄱ, ㄴ, ㄷ`,
    choices: ["ㄱ", "ㄷ", "ㄱ, ㄴ", "ㄴ, ㄷ", "ㄱ, ㄴ, ㄷ"],
    keyPoint: "w²+w+1=0, w+w̄=-1, ww̄=1 이용. ㄱ: w̄도 x³=1의 허근 → w̄³=1 (참). ㄴ: w²+w+1=0, w̄²+w̄+1=0 이용하면 양변 모두 -1 (참). ㄷ: (-w-1)ⁿ=(-1)ⁿ×(w²)ⁿ, 우변도 동일 → 1=(-1)ⁿ → n이 짝수 → 50개 (참)",
    solution: `w²+w+1=0, w+w̄=-1, ww̄=1
ㄱ. w̄는 x³=1의 다른 허근 → w̄³=1 (참)
ㄴ. 1/w+(1/w)² = (w+1)/w² = -w²/w² = -1
   1/w̄+(1/w̄)² = (w̄+1)/w̄² = -w̄²/w̄² = -1 (참)
ㄷ. (-w-1)ⁿ = (w²)ⁿ
   w̄/(w+w̄) = w̄/(-1) = -w̄ = -1/w
   우변: (-1/w)ⁿ = (-1)ⁿ×(w²)ⁿ
   (w²)ⁿ = (-1)ⁿ×(w²)ⁿ → (-1)ⁿ=1 → n은 짝수
   100 이하 짝수: 50개 (참)
∴ ㄱ, ㄴ, ㄷ`
  }
  ,{
    id: "2018_6월_고1_11번",
    year: 2018, month: 6, grade: 1, num: 11,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "②",
    answerNum: 2,
    keywords: ["연립방정식", "이차연립방정식", "해의일치"],
    problemImg: `${GITHUB_IMG_BASE}/18_06_고1_11_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/18_06_고1_11_A.jpg`,
    problem: `x, y에 대한 두 연립방정식
{3x+y=a, 2x+2y=1} , {x²-y²=-1, x-y=b}
의 해가 일치할 때, 두 상수 a, b에 대하여 ab의 값은? [3점]

① 1   ② 2   ③ 3   ④ 4   ⑤ 5`,
    choices: ["1","2","3","4","5"],
    keyPoint: "공통 방정식 {2x+2y=1, x²-y²=-1}을 먼저 풀어 x, y값 구하기. x²-y²=(x+y)(x-y) 인수분해 이용. x=-3/4, y=5/4 → a=-1, b=-2 → ab=2",
    solution: `연립방정식 {2x+2y=1, x²-y²=-1}의 해를 구함
y = 1/2 - x 대입: x²-(1/2-x)² = -1
x = -3/4, y = 5/4
3x+y = a → a = -1
x-y = b → b = -2
∴ ab = (-1)×(-2) = 2`
  ...
  ,{
    id: "2021_11월_고1_12번",
    year: 2021, month: 11, grade: 1, num: 12,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "③",
    answerNum: 3,
    keywords: ["연립방정식", "이차연립방정식", "인수분해"],
    problemImg: `${GITHUB_IMG_BASE}/21_11_고1_12_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/21_11_고1_12_A.jpg`,
    problem: `연립방정식
{3x-2y=7, 6x²-xy-2y²=0}
...
① 1   ② 2   ③ 3   ④ 4   ⑤ 5`,
    choices: ["1","2","3","4","5"],
    keyPoint: "6x²-xy-2y²=(2x+y)(3x-2y)=0으로 인수분해. 3x-2y=7이 이미 있으므로 2x+y=0 → y=-2x 대입. x=1, y=-2 → α-β=3",
    solution: `6x²-xy-2y² = (2x+y)(3x-2y) = 0
3x-2y=7이 주어졌으므로 2x+y=0
y=-2x를 3x-2y=7에 대입: 7x=7 → x=1, y=-2
α=1, β=-2
∴ α-β = 3`
  }
  ,{
    id: "2024_6월_고1_13번",
    year: 2024, month: 6, grade: 1, num: 13,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "②",
    answerNum: 2,
    keywords: ["연립방정식", "판별식", "서로다른두실수", "자연수"],
    problemImg: `${GITHUB_IMG_BASE}/24_06_고1_13_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/24_06_고1_13_A.jpg`,
    problem: `x, y에 대한 연립방정식
{x-y=3, x²-xy-y²=k}
의 해를 {x=α, y=α-3} 또는 {x=β, y=β-3} 이라 하자.
α, β가 서로 다른 두 실수가 되도록 하는 자연수 k의 최댓값은? [3점]

① 10   ② 11   ③ 12   ④ 13   ⑤ 14`,
    choices: ["10","11","12","13","14"],
    keyPoint: "y=x-3을 대입하면 x²-9x+k+9=0. 서로 다른 두 실근 조건: D>0 → 81-4(k+9)>0 → k<45/4=11.25 → 자연수 최댓값 11",
    solution: `y=x-3을 x²-xy-y²=k에 대입
x²-x(x-3)-(x-3)²=k
x²-9x+k+9=0
서로 다른 두 실근 조건: D>0
D = 81-4(k+9) > 0
45-4k > 0 → k < 45/4 = 11.25
∴ 자연수 k의 최댓값 = 11`
  }
  ,{
    id: "2024_10월_고1_6번",
    year: 2024, month: 10, grade: 1, num: 6,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "④",
    answerNum: 4,
    keywords: ["연립방정식", "이차연립방정식", "합"],
    problemImg: `${GITHUB_IMG_BASE}/24_10_고1_06_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/24_10_고1_06_A.jpg`,
    problem: `연립방정식
{x-y=2, x²+8x+y²=2}
의 해를 x=α, y=β라 할 때, α+β의 값은? [3점]
...
① -1   ② -2   ③ -3   ④ -4   ⑤ -5`,
    choices: ["-1","-2","-3","-4","-5"],
    keyPoint: "y=x-2를 두 번째 식에 대입 → 2(x+1)²=0 → x=-1(중근). y=-3. α+β=-1+(-3)=-4",
    solution: `y=x-2를 x²+8x+y²=2에 대입
x²+8x+(x-2)²=2
2x²+4x+2=0
2(x+1)²=0 → x=-1(중근)
y=-1-2=-3
...
∴ α+β = -4`
  ...
  ,{
    id: "2025_6월_고1_9번",
    year: 2025, month: 6, grade: 1, num: 9,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "②",
    answerNum: 2,
    keywords: ["연립방정식", "이차연립방정식", "합"],
    problemImg: `${GITHUB_IMG_BASE}/25_06_고1_09_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/25_06_고1_09_A.jpg`,
    problem: `연립방정식
{x-y=3, 2x²+y²=6}
의 해를 x=α, y=β라 할 때, α+β의 값은? [3점]
...
① -2   ② -1   ③ 0   ④ 1   ⑤ 2`,
    choices: ["-2","-1","0","1","2"],
    keyPoint: "x=y+3을 2x²+y²=6에 대입 → 3(y+2)²=0 → y=-2(중근), x=1. α+β=1+(-2)=-1",
    solution: `x=y+3을 2x²+y²=6에 대입
2(y+3)²+y²=6
3y²+12y+12=0
3(y+2)²=0 → y=-2(중근)
x=1
...
∴ α+β = -1`
  ...
  ,{
    ...
    answerNum: 2,
    keywords: ["연립방정식", "이차연립방정식", "합"],
    problemImg: `${GITHUB_IMG_BASE}/25_09_고1_10_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/25_09_고1_10_A.jpg`,
    problem: `연립방정식
{2x-y=4, 3x²-xy-7y=3}
의 해를 x=α, y=β라 할 때, α+β의 값은? [3점]
...
① 8   ② 11   ③ 14   ④ 17   ⑤ 20`,
    choices: ["8","11","14","17","20"],
    keyPoint: "y=2x-4를 두 번째 식에 대입 → (x-5)²=0 → x=5(중근), y=6. α+β=5+6=11",
    solution: `y=2x-4를 3x²-xy-7y=3에 대입
3x²-x(2x-4)-7(2x-4)=3
x²-10x+25=0
(x-5)²=0 → x=5(중근)
y=2(5)-4=6
...
∴ α+β = 11`
  ...
  ,{
    id: "2016_9월_고1_9번",
    year: 2016, month: 9, grade: 1, num: 9,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "⑤",
    answerNum: 5,
    keywords: ["복소수", "등식", "실수부", "허수부", "연립방정식"],
    problemImg: `${GITHUB_IMG_BASE}/16_09_고1_09_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/16_09_고1_09_A.jpg`,
    problem: `등식 (3+2i)x²-5(2y+i)x=8+12i를 만족시키는 두 정수 x, y에 대하여
x+y의 값은? (단, i=√-1) [3점]

① 1   ② 2   ③ 3   ④ 4   ⑤ 5`,
    choices: ["1","2","3","4","5"],
    keyPoint: "좌변을 실수부·허수부로 분리 → {3x²-10xy=8, 2x²-5x=12}. ㉡에서 (2x+3)(x-4)=0, x는 정수이므로 x=4 → y=1 → x+y=5",
    solution: `(3+2i)x²-5(2y+i)x = 8+12i
3x²-10xy + (2x²-5x)i = 8+12i
실수부: 3x²-10xy=8 ···㉠
허수부: 2x²-5x=12 ···㉡
㉡에서 (2x+3)(x-4)=0, x는 정수이므로 x=4
x=4를 ㉠에 대입: 48-40y=8, y=1
∴ x+y = 5`
  }
  ,{
    id: "2018_6월_고1_28번",
    year: 2018, month: 6, grade: 1, num: 28,
    unit: "방정식과부등식",
    score: 4,
    type: "단답형",
    answer: "60",
    answerNum: null,
    keywords: ["복소수", "겉넓이", "유리수조건", "연립방정식", "정육면체", "원기둥"],
    problemImg: `${GITHUB_IMG_BASE}/18_06_고1_28_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/18_06_고1_28_A.jpg`,
    problem: `한 모서리의 길이가 a인 정육면체 모양의 입체도형이 있다. 이 입체도형에서 그림과 같이 밑면의 반지름의 길이가 b이고 높이가 a인 원기둥 모양의 구멍을 뚫었다. 남아 있는 입체도형의 겉넓이가 216+16π일 때, 두 유리수 a, b에 대하여 15(a-b)의 값을 구하시오. (단, a>2b) [4점]`,
    choices: [],
    keyPoint: "겉넓이 = 6a²-2πb²+2πab = 216+16π. a,b가 유리수이므로 유리수 부분·π 계수 각각 분리: 6a²=216, ab-b²=8. a=6 대입 → b²-6b+8=0 → b=2 또는 b=4. a>2b 조건으로 b=2. 15(a-b)=60",
    solution: `겉넓이: 6a²-2πb²+2πab = 216+16π
6a²+2π(ab-b²) = 216+16π
a,b가 유리수이므로:
6a²=216 → a²=36 → a=6 (∵a>0)
ab-b²=8 → 6b-b²=8 → b²-6b+8=0
(b-2)(b-4)=0 → b=2 또는 b=4
a>2b 조건: b=2
∴ 15(a-b) = 15×(6-2) = 60`
  }
  ,{
    id: "2022_6월_고1_12번",
    year: 2022, month: 6, grade: 1, num: 12,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "①",
    answerNum: 1,
    keywords: ["연립방정식", "이차연립방정식", "근과계수의관계"],
    problemImg: `${GITHUB_IMG_BASE}/22_06_고1_12_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/22_06_고1_12_A.jpg`,
    problem: `연립방정식
{x+y+xy=8, 2x+2y-xy=4}
의 해를 x=α, y=β라 할 때, α²+β²의 값은? [3점]

① 8   ② 10   ③ 12   ④ 14   ⑤ 16`,
    choices: ["8","10","12","14","16"],
    keyPoint: "두 식을 더하면 3(x+y)=12 → x+y=4. ㉠에 대입하면 xy=4. 근과 계수의 관계: α+β=4, αβ=4 → α²+β²=(α+β)²-2αβ=16-8=8",
    solution: `㉠+㉡: 3(x+y)=12 → x+y=4
㉠에 대입: 4+xy=8 → xy=4
α+β=4, αβ=4
∴ α²+β² = (α+β)²-2αβ = 16-8 = 8`
  }
  ,{
    id: "2024_9월_고1_25번",
    year: 2024, month: 9, grade: 1, num: 25,
    unit: "방정식과부등식",
    score: 3,
    type: "단답형",
    answer: "18",
    answerNum: null,
    keywords: ["연립방정식", "이차연립방정식", "인수분해", "완전제곱"],
    problemImg: `${GITHUB_IMG_BASE}/24_09_고1_25_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/24_09_고1_25_A.jpg`,
    problem: `연립방정식
{x²-4xy+4y²=0, x²-6x-12y+36=0}
의 해가 x=α, y=β일 때, αβ의 값을 구하시오. [3점]`,
    choices: [],
    keyPoint: "㉠: (x-2y)²=0 → x=2y. ㉡에 x=2y 대입: (2y)²-12y-12y+36=0 → 4y²-24y+36=0 → (y-3)²=0 → y=3, x=6. αβ=18",
    solution: `㉠: x²-4xy+4y²=(x-2y)²=0 → x=2y
㉡에 x=2y 대입:
4y²-12y-12y+36=0
4y²-24y+36=0
(y-3)²=0 → y=3, x=6
...
∴ αβ = 18`
  ...
  ,{
    id: "2025_3월_고2_13번",
    year: 2025, month: 3, grade: 2, num: 13,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "⑤",
    answerNum: 5,
    keywords: ["연립방정식", "이차연립방정식", "인수분해", "무리수"],
    problemImg: `${GITHUB_IMG_BASE}/25_03_고2_13_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/25_03_고2_13_A.jpg`,
    problem: `연립방정식
{2x²-5xy+2y²=0, 4x²-y²=45}
의 해를 x=α, y=β라 할 때, α+β의 값은?
(단, α>0, β>0) [3점]

① √3   ② 3√3/2   ③ 2√3   ④ 5√3/2   ⑤ 3√3`,
    choices: ["√3","3√3/2","2√3","5√3/2","3√3"],
    keyPoint: "㉠: (2x-y)(x-2y)=0 → x=y/2 또는 x=2y. x=y/2를 ㉡에 대입하면 0=45 불가. x=2y를 ㉡에 대입: 15y²=45 → y=√3 (∵β>0), x=2√3. α+β=3√3",
    solution: `㉠: (2x-y)(x-2y)=0
(i) x=y/2: 4(y/2)²-y²=0≠45 불가
(ii) x=2y: 4(2y)²-y²=15y²=45
y²=3 → y=√3 (∵β>0), x=2√3
α=2√3, β=√3
∴ α+β = 3√3`
  }
  ,{
    id: "2024_9월_고1_23번",
    year: 2024, month: 9, grade: 1, num: 23,
    unit: "방정식과부등식",
    score: 3,
    type: "단답형",
    answer: "9",
    answerNum: null,
    keywords: ["연립부등식", "일차부등식", "정수", "개수"],
    problemImg: `${GITHUB_IMG_BASE}/24_09_고1_23_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/24_09_고1_23_A.jpg`,
    problem: `연립부등식
{2x ≤ x+11, x+5 < 4x-2}
를 만족시키는 모든 정수 x의 개수를 구하시오. [3점]`,
    choices: [],
    keyPoint: "각 부등식을 따로 풀어 교집합. 2x≤x+11 → x≤11. x+5<4x-2 → x>7/3. 연립하면 7/3<x≤11. 정수: 3,4,5,6,7,8,9,10,11 → 9개",
    solution: `2x≤x+11 → x≤11 ···㉠
x+5<4x-2 → x>7/3 ···㉡
㉠,㉡에서 7/3<x≤11
정수 x: 3,4,5,6,7,8,9,10,11
∴ 개수 = 9`
  }
  ,{
    id: "2025_6월_고1_6번",
    year: 2025, month: 6, grade: 1, num: 6,
    unit: "방정식과부등식",
    score: 3,
    type: "선택형",
    answer: "⑤",
    answerNum: 5,
    keywords: ["연립부등식", "일차부등식", "정수", "합"],
    problemImg: `${GITHUB_IMG_BASE}/25_06_고1_06_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/25_06_고1_06_A.jpg`,
    problem: `연립부등식
{3x ≥ x-3, 2x+1 ≤ 11}
...
① 10   ② 11   ③ 12   ④ 13   ⑤ 14`,
    choices: ["10","11","12","13","14"],
    keyPoint: "3x≥x-3 → x≥-3/2. 2x+1≤11 → x≤5. 연립하면 -3/2≤x≤5. 정수: -1,0,1,2,3,4,5 → 합=(-1)+0+1+2+3+4+5=14",
    solution: `3x≥x-3 → x≥-3/2 ···㉠
2x+1≤11 → x≤5 ···㉡
㉠,㉡에서 -3/2≤x≤5
정수 x: -1,0,1,2,3,4,5
∴ 합 = (-1)+0+1+2+3+4+5 = 14`
  ...
  ,{
    ...
    answerNum: null,
    keywords: ["연립부등식", "일차부등식", "정수", "합"],
    problemImg: `${GITHUB_IMG_BASE}/25_09_고1_23_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/25_09_고1_23_A.jpg`,
    problem: `연립부등식
{3x ≤ x+16, x+8 ≤ 4x-10}
을 만족시키는 모든 정수 x의 값의 합을 구하시오. [3점]`,
    choices: [],
    keyPoint: "3x≤x+16 → x≤8. x+8≤4x-10 → x≥6. 연립하면 6≤x≤8. 정수: 6,7,8 → 합=6+7+8=21",
    solution: `3x≤x+16 → x≤8 ···㉠
x+8≤4x-10 → x≥6 ···㉡
㉠,㉡에서 6≤x≤8
정수 x: 6,7,8
∴ 합 = 6+7+8 = 21`
  ...
  ,{
    id: "2019_6월_고1_15번",
    year: 2019, month: 6, grade: 1, num: 15,
    unit: "방정식과부등식",
    score: 4,
    type: "선택형",
    answer: "⑤",
    answerNum: 5,
    keywords: ["연립부등식", "매개변수", "정수", "합", "자연수최댓값"],
    problemImg: `${GITHUB_IMG_BASE}/19_06_고1_15_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/19_06_고1_15_A.jpg`,
    problem: `x에 대한 연립부등식
{x+2 > 3, 3x < a+1}
을 만족시키는 모든 정수 x의 값의 합이 9가 되도록 하는 자연수 a의 최댓값은? [4점]

① 10   ② 11   ③ 12   ④ 13   ⑤ 14`,
    choices: ["10","11","12","13","14"],
    keyPoint: "x+2>3 → x>1. 3x<a+1 → x<(a+1)/3. 정수 합이 9=2+3+4가 되려면 정수 범위가 1<x≤4(또는 5 미만). 4<(a+1)/3≤5 → 11<a≤14 → 자연수 최댓값 14",
    solution: `x+2>3 → x>1 ···㉠
3x<a+1 → x<(a+1)/3 ···㉡
정수 합=9이 되는 정수: 2,3,4 (합=9)
∴ 4 < (a+1)/3 ≤ 5
12 < a+1 ≤ 15
11 < a ≤ 14
∴ 자연수 a의 최댓값 = 14`
  ...
  ,{
    id: "2020_3월_고1_28번",
    year: 2020, month: 3, grade: 1, num: 28,
    unit: "방정식과부등식",
    score: 4,
    type: "단답형",
    answer: "59",
    answerNum: null,
    keywords: ["부등식활용", "연립부등식", "문장제", "최댓값최솟값"],
    problemImg: `${GITHUB_IMG_BASE}/20_03_고1_28_Q.jpg`,
    solutionImg: `${GITHUB_IMG_BASE}/20_03_고1_28_A.jpg`,
    problem: `다음은 어느 학교의 수학 캠프에서 두 학생이 참가자들에게 나눠줄 초콜릿을 상자에 담으면서 나눈 대화의 일부이다.

모든 상자에 10개씩 담으면 초콜릿이 42개 남아.
그러면 한 상자에 초콜릿을 13개씩 담으면 어떨까?
13개가 채워지지 않는 상자가 1개 있고 빈 상자가 3개 남게 돼.

위 학생들의 대화를 만족시키는 상자의 개수의 최댓값을 M, 최솟값을 m이라 할 때, M+m의 값을 구하시오. [4점]`,
    choices: [],
    keyPoint: "상자 수를 x라 하면 초콜릿 수=10x+42. 13개씩 담으면 (x-4)개 상자는 13개, 나머지 1개는 미만, 빈 상자 3개. 조건: 13(x-4)<10x+42이고 10x+42<13(x-3). 연립하면 27<x<94/3. M=31, m=28 → M+m=59",
    solution: `상자 수를 x, 초콜릿 수=10x+42
13개씩 담으면: (x-4)개에 13개씩, 1개는 미만, 3개 빈 상자
13(x-4) < 10x+42 → 3x<94 → x<94/3 ···㉠
10x+42 < 13(x-3) → 3x>81 → x>27 ···㉡
27 < x < 94/3
M=31, m=28
∴ M+m = 59`
  }
